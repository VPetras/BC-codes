...
def decode(data):
    if len(data) != 6 and len(data) != 10:
        print("Bad data length, 6 or 10 characters expected")
...
def pprint(data):
    ...
    print('Flood detector :', data['flood_detector'], '>>>', 'IS WATER' if data['flood_detector'] else 'NO WATER')
...
if __name__ == '__main__':
    if len(sys.argv) != 2 or sys.argv[1] in ('help', '-h', '--help'):
        ...
        print("example BOOT paket: python3 decode.py 06716a")
        print("example BEACON paket: python3 decode.py 125064")
        print("example ALERT paket: python3 decode.py 26716a0001")
        print("example ALERT paket: python3 decode.py 268160000a")
